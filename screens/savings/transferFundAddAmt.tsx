...
const TransferFundAddAmt: React.FC<Props> = props => {
  //States
  ...
  const selectedBank = props.route.params.selectedBank;
  //Helpers
  ...
  return (
    <Layout
      ...
      <Navbar
        ...
        subText={`Enter an amount to transfer to your bank`}
      />
      ...
      <Button
        title={'Transfer Fund'}
        disabled={pagesForm.amt === ''}
        onPress={() => {
          navigate('TransferFundVerify', {
            fromWithdrawDeposit: false,
...
export default TransferFundAddAmt;
